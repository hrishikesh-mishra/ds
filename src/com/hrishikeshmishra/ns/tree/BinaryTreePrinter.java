 ...
 *  Print binary tree
 *
 *  @link http://hrishikeshmishra.com/print-binary-tree/
 * </p>
...
public class BinaryTreePrinter {
    ...
    public <E> void print(List<BinaryTreeNode<E>> nodes, int currentLevel, int maxLevel){
    ...
    private <E> boolean isAllEmpty(List<BinaryTreeNode<E>> nodes) {
        for (BinaryTreeNode<E> node: nodes)
    ...
    public <E> int getTreeHeight(BinaryTreeNode<E> node){
